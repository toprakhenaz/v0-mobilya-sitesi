...
export const metadata: Metadata = {
  title: "KVKK Aydınlatma Metni | Divona Home",
  description: "Divona Home KVKK Kişisel Verilerin Korunması Kanunu Aydınlatma Metni.",
}
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <div className="prose max-w-none">
          <p>
            Divona Home olarak kişisel verilerinizin güvenliği ve gizliliği konusunda azami hassasiyet göstermekteyiz.
            Bu bilinçle, Divona Home olarak ürün ve hizmetlerimizden faydalanan müşterilerimiz dahil, tüm paydaşlarımıza
            ait her türlü kişisel verilerin 6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK")'na uygun olarak
            işlenmesine, kaydedilmesine, aktarılmasına, paylaşılmasına ve saklanmasına büyük önem vermekteyiz.
          </p>
          ...
          <p>
            ...
            Divona Home Ltd. Şti. tarafından aşağıda açıklanan kapsamda işlenebilecektir.
          </p>
          ...
          <p>
            ...
            dahilinde işlenecektir. Divona Home tarafından kişisel verileriniz aşağıda belirtilen amaç ve hukuki
          ...
          <p>KVKK'nın 11. maddesi uyarınca, Divona Home'a başvurarak aşağıdaki haklarınızı kullanabilirsiniz:</p>
          ...
          <p>
            ...
            info@divonahome.com adresine iletebilirsiniz.
          </p>
        </div>
      </div>
    </div>
