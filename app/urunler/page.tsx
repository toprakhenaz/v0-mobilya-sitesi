...
export default function ProductsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch products
        const { products: productsData, total } = await getProducts(undefined, filters, currentPage, productsPerPage)
  ...
  return (
    <div className="py-6">
      <div className="container-custom">
        ...
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Tüm Ürünler</h1>
          <p className="text-gray-600">Bahçe mobilyalarımızın tüm koleksiyonunu keşfedin</p>
        </div>
